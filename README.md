...
Flight Data Visualizer: Processes historical UAV flight data from .bin files, rendering detailed 2D flight paths on interactive maps and visualizing telemetry metrics (altitude, speed, yaw, pitch) through dynamic, interactive graphs. It supports animated playback and real-time telemetry updates for comprehensive mission review.
...
Install Dependencies:Ensure Node.js (v16+) is installed, then run:
npm install
...
GitHub Issues: github.com/your-username/uav-flight-planner-visualizer/issues
